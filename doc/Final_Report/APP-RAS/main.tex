...
These packages theorotically arrive without any pre-planning and hence the system should be able to accomodate for the unpredictable demand. 
\\
...
\item The system must be stable enough to be able to perform multiple tasks concurrently and accomodate for inter-robot interactions.  
\end{itemize} 
\subsection{Related Literature}
how literature approaches to it (very briefly as we have a related works section)
\subsection{Approach}
how was your approach
how did you show your results and how was it resulted
\\
Note that these points above should be a summary of everything. With 1-3 sentences each (can change of course), but normally Introduction part takes upto 1,5 pages in the paper format.
The trick here is that, you can first write your introduction and copy-paste some parts to the abstract.
