...
\author{Vincent W\"olfer, Florian Ziesche, Patrick Denzler, Shreyas Gokhale, Uros Petkovic: Group3}
...
Showing the architecture graph and describing the system architecture. How the components work together and what's their part in the system. No detailed explanation how the components work, as this is done in each components section.

\subsection{Task Planning}
\label{subsec:Task Planning}
...
Describing how the path planning works. At the end of the planning the paths need to be reservated, beeing described in coordination.
...
We only consider the following situation for possible improvement:
