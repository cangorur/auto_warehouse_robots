...
\begin{figure}[h]
	...
	\caption{Average time split: drive to pick up / drop off, pick up and drop off}
...
\begin{figure}[h]
	...
	\caption{Average Package Delivery Time by Number of Robots, , Waiting time is time spent when the task was in waiting queue}
