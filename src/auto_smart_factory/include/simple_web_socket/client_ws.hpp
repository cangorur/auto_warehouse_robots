...
#pragma warning(disable: 4996)
	...
	public:
		...
		private:
			...
			class SendData {
			public:
				SendData(const std::shared_ptr<SendStream>& send_stream,
					                  ...
					                  asio::async_read_until(*connection->socket, message->streambuf, "\r\n\r\n",
					                                         [this, message, nonce_base64]
						                                         ...
						                                         if(!ec) {
							                                         ...
							                                         auto header_it = connection->header.find(
							                                         ...
							                                         if(header_it != connection->header.end() &&
							                                            ...
							                                            Crypto::sha1(*nonce_base64 + ws_magic_string)) {
								                                         ...
								                                         on_error(make_error_code::make_error_code(
										                                         errc::protocol_error));
							                                         }
						                                         } else if(on_error) {
							                                         on_error(ec);
			                 ...
			                 [this, message](const error_code& ec, size_t bytes_transferred) {
				                 if(!ec) {
					                 ...
					                 if(length == 126) {
						                 ...
						                 asio::async_read(*connection->socket, message->streambuf,
				                 ...
				                 if(!ec) {
					                 ...
					                 if((message->fin_rsv_opcode & 0x0f) == 8) {
						                 ...
						                 send_close(status, reason,
						                            [this, kept_connection](const error_code& /*ec*/) {});
						                 if(on_close) {
