...
warehouse_config_file = os.path.join(os.path.dirname(__file__), '../../configs/smart_factory_config_walls.json')
#warehouse_config_file = os.path.join(os.path.dirname(__file__), '../../configs/smart_factory_config_walls.json')
...
# setup map. simply_flag decides to put walls around the map. False for a scenario with walls (harder computation)
...
wall_size_x = map_config['wall_geometry']['width']
wall_size_y = map_config['wall_geometry']['height']
