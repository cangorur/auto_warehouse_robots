...
warehouse_config_file = os.path.join(os.path.dirname(__file__), '../../configs/smart_factory_config_storages.json')
#warehouse_config_file = os.path.join(os.path.dirname(__file__), '../../configs/smart_factory_config_simple_storages.json')
